...
if __name__ == '__main__':
    ...
    fig, ax = plt.subplots()
    num_bins = 100
    n, bins, patches = ax.hist(err_rate_list, num_bins, facecolor='crimson', alpha=0.5)

    # prettify
    ax.set_title('Figure 3: Pocket Algorithm statistics of $w_{100}$')
